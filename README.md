...
|---|---|
| `basic` | Photo + name |
| `simple` (default) | + confidence/time badges, today/species/total stats |
| `advanced` | + connectivity pill, "top species today" mini-section |
...
Then: **Settings → Devices & Services → Add Integration → "BirdNET-Go"** (pictured above), enter your BirdNET-Go host (e.g. `192.168.1.50:8080` or a domain if you reverse-proxy it with HTTPS). For HAOS / LAN / VPN layouts, see [HAOS & network topologies](docs/haos-network.md).
